...
const ClientDashboardScreen = () => {
  ...
  const latestCase = cases[0] ? { caseId: cases[0].caseId, caseNumber: cases[0].docketNo, title: cases[0].caseName, lawyer: cases[0].lawyer, status: cases[0].status, nextHearing: "Not available", payment: "Not available" } : null;
